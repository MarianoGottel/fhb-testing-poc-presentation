...
export function DemoShowcaseSlide() {
    ...
    return (
        <SlideContainer transition='scale' className='bg-gradient-to-br from-[#0A0A0A] via-[#000D1A] to-[#0A0A0A]'>
            <div className='w-full max-w-7xl'>
                            ...
                            <motion.div
                                ...
                                <div className='relative z-10'>
                                    <div className='mb-3 flex items-center space-x-3'>
                                        <div className='rounded-lg p-2' style={{ backgroundColor: `${demo.color}20` }}>
                ...
                <div className='mb-6 grid gap-6 md:grid-cols-2'>
                    ...
                    <motion.div
                        ...
                        className='rounded-xl border border-[#66B2FF]/30 bg-gradient-to-r from-[#66B2FF]/10 to-[#66B2FF]/5 p-5'>
                    ...
                    <motion.div
                        ...
                        <div className='mb-4 space-y-2'>
                            ...
                            <div className='flex items-center space-x-3 rounded-lg bg-black/40 p-2'>
                                ...
                                <div className='flex-1'>
                                    <div className='text-sm font-medium text-white'>Output: Component + Storybook</div>
                ...
                <motion.div
                    ...
                    <div className='grid gap-4 md:grid-cols-3'>
                        ...
                        <div className='rounded-lg bg-black/40 p-4'>
                            ...
                            <p className='text-sm text-white/70'>Both workflows 99.5% faster than manual</p>
                        </div>
                    </div>
