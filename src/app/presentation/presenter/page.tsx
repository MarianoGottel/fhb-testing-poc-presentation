...
import { getSlideByIndex, SLIDES } from '@/lib/presentation/slides'
...
export default function PresenterPage() {
  ...
  const NextSlideComponent = currentSlide < slideComponents.length - 1 
    ? slideComponents[currentSlide + 1] 
    : null
    ...
    <div className="flex h-screen bg-gray-900">
      ...
      <div className="w-96 border-l border-gray-700 bg-gray-800 p-6 overflow-y-auto">
        ...
        <div className="mb-6">
          ...
          <div className="rounded bg-gray-700 p-4 text-sm text-white/80 leading-relaxed">
        ...
        {NextSlideComponent && (
          <div className="mb-6">
            ...
            <div className="rounded bg-gray-700 p-4">
              <h4 className="font-medium text-[#4ECDC4]">
